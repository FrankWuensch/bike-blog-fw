...
Nach langer und ausführlicher Vorbereitung geht es endlich los. Zunächst fahre ich zum Bahnhof Wendlingen, um von dort um 10:20 Uhr mit dem Zug nach Ulm zu fahren. Anschließend geht es mit dem RE75 bis nach Oberstdorf. Dort angekommen, fahre ich mit dem Fahrrad bis zur Schanze und mache beim [Schanzenwirt](https://schonzewiert.de/) eine Mittagspause. Gut gestärkt geht es bis nach Kempten.

<img src="{{site.baseurl}}src/images/2024/schanze.jpg" alt="Schanze Oberstdorf" loading="lazy" class="w-full xl:mx-auto xl:w-[75%]">
...
<img src="{{site.baseurl}}src/images/2024/abgebrochener_radweg.JPG" alt="Umleitung wegen Radwegschäden" loading="lazy" class="w-full xl:mx-auto xl:w-[75%]">
...
<img src="{{site.baseurl}}src/images/2024/mohn.JPG" alt="Mohnfeld" loading="lazy" class="w-full xl:mx-auto xl:w-[75%]">
...
<img src="{{site.baseurl}}src/images/2024/gleichschritt.JPG" alt="Störche im Gleichschritt" loading="lazy" class="w-full xl:mx-auto xl:w-[75%]">
...
<img src="{{site.baseurl}}src/images/2024/biber.jpg" alt="Warnschild Biberfraß" loading="lazy" class="w-full xl:mx-auto xl:w-[75%]">
...
<img src="{{site.baseurl}}src/images/2024/wasserkuppe.jpg" alt="Wasserkuppe" loading="lazy" class="w-full xl:mx-auto xl:w-[75%]">
...
<img src="{{site.baseurl}}src/images/2024/zelt.JPG" alt="Übernachtung im Zelt" loading="lazy" class="w-full xl:mx-auto xl:w-[75%]">

### Tag 7

Diese Etappe führt mich durch wunderschöne, ruhige Täler bis nach Jestädt in der Nähe von Eschwege in Hessen. Hier buche ich mir auf dem Weg eine *Bett + Bike* Unterkunft. Um kurz vor 19 Uhr erreiche ich die [Villa Velo](https://pension-villa-velo.de/). Ich kann diese Unterkunft jedem weiterempfehlen!

<img src="{{site.baseurl}}src/images/2024/villa_velo.jpg" alt="Villa Velo" loading="lazy" class="w-full xl:mx-auto xl:w-[75%]">
...
<img src="{{site.baseurl}}src/images/2024/brocken.jpg" alt="Brocken" loading="lazy" class="w-full xl:mx-auto xl:w-[75%]">

<img src="{{site.baseurl}}src/images/2024/brocken_aussicht.jpg" alt="Aussicht Brocken" loading="lazy" class="w-full xl:mx-auto xl:w-[75%]">
...
<img src="{{site.baseurl}}src/images/2024/hitzacker.jpg" alt="Destinature Dorf Hitzacker" loading="lazy" class="w-full xl:mx-auto xl:w-[75%]">
...
<img src="{{site.baseurl}}src/images/2024/gorch_fock.JPG" alt="Segelschulschiff Gorch Fock" loading="lazy" class="w-full xl:mx-auto xl:w-[75%]">
...
<img src="{{site.baseurl}}src/images/2024/meer.JPG" alt="Stürmisches Meer" loading="lazy" class="w-full xl:mx-auto xl:w-[75%]">
...
<img src="{{site.baseurl}}src/images/2024/fahrradtransport.jpg" alt="Fahrradtransport Deutsche Bahn" loading="lazy" class="w-full xl:mx-auto xl:w-[75%]">
